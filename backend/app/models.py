...
class Attendance(Base):
    ...
    is_late_override: Mapped[bool | None] = mapped_column(Boolean, nullable=True, default=None)  # True/False nếu quản lý đè trễ, None = tự động
    note: Mapped[str | None] = mapped_column(Text)
    created_at: Mapped[datetime] = mapped_column(DateTime, server_default=func.now())
    ...
    def is_late(self) -> bool:
        ...
        Đúng giờ (bằng mốc) KHÔNG tính muộn. Cho phép Quản lý/Giám đốc đè (is_late_override)."""
